...
catch_del_shp = r'C:\ecan\local\Projects\otop\GIS\vector\min_flow\catch_sites_join.shp'
catch_sites_csv = r'C:\ecan\local\Projects\otop\GIS\vector\min_flow\results\catch_sites.csv'
export_sites_shp = 'C:/ecan/local/Projects/otop/GIS/vector/min_flow/flow_sites.shp'
crc_col = 'crc'
export_catch_shp = 'C:/ecan/local/Projects/otop/GIS/vector/min_flow/results/catch_del_poly.shp'
