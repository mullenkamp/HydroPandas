...
base_dir = r'E:\ecan\local\Projects\requests\waimak\2017-06-12'
...
export_sites_shp = r'E:\ecan\local\Projects\requests\waimak\2017-06-12\sites.shp'
crc_col = 'crc'
...
sites_m.extend([270, 1516, 389, 66215, 253, 1278])

h1 = hydro().get_data('flow_m', sites_m)
h2 = h1.get_data('flow', sites.site, qual_codes)

sites_geo = flow_sites_to_shp(h2.sites, export=True, export_path=export_sites_shp)
...
arc_catch_del(base_dir, bound_shp, export_sites_shp)
