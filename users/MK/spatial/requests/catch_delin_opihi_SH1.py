...
###############################
#### Then run the arcgis catchment delineation script in arcgis
...
crc_catch2, catch4 = pts_poly_join(allo_loc, catch_del, 'site')


###########################
#### Select the necessary sites

crc1 = crc_catch2[crc_catch2.site.isin(sites_all)].crc
