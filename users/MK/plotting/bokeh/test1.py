# -*- coding: utf-8 -*-
"""
Created on Wed Aug 16 12:02:48 2017

@author: MichaelEK
"""
from bokeh.models import DataRange1d, Plot
...
xdr = DataRange1d(sources=[source.data["dates"]])
ydr = DataRange1d(sources=[source.data["sunrises", "sunsets"]])
...
base_path = r'C:\ecan\local\Projects\plotting'
test1 = 'callback1.html'

output_file(join(base_path, test1))
