...
## output parameters
export_results_path = 'C:/ecan/shared/projects/otop/reports/current_state_2016/allo_results'
export_path = 'C:/ecan/shared/projects/otop/reports/current_state_2016/figures/allo_use_v02'
swaz_path = 'SWAZ'
name4 = 'otop'
name5 = 'otop_past'
name7 = 'minor_swaz'
...
otop1 = w_query(allo_use2, grp_by=['dates', 'swaz_grp', 'swaz', 'use_type'], allo_col=allo_col, cwms_zone=cwms_zone, take_type=take_type, export_path=export_results_path, export=False)
