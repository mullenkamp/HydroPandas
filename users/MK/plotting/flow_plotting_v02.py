...
from import_fun import rd_hydstra_csv, rd_henry, rd_ts
...
## import parameters
flow_csv = 'C:/ecan/shared/base_data/flow/otop/otop_flow_recorders.CSV'
nat_flow_csv = 'C:/ecan/shared/base_data/flow/otop/rec_flow_nat_v02.csv'
...
## Other parameters
par_lst = [70105, 70103]
tengawai_lst = [69621, 69635]
opihi_lst = [69618, 69607]
opuha_lst = [69619, 69661]
...
site_names_dict = {70105: 'Huts', 70103: 'SH1', 69621: 'Rockburn', 69635: 'Picnic Grounds', 69618: 'Rockwood', 69607: 'SH1', 69619: 'Stoneleigh Road', 69661: 'Downstream Weir', 69602: 'Manse Bridge'}

river_lst = [par_lst, tengawai_lst, opihi_lst, opuha_lst, temuka_lst]
river_names = ['Pareora', 'Tengawai', 'Opihi', 'Opuha', 'Temuka']
...
## output parameters
export_path = 'C:/ecan/shared/projects/otop/reports/current_state_2016/figures/flow_v02'
export_name_flow = 'flow_dual_boxplot.png'
export_name_flow_2004 = 'flow_dual_boxplot_2004-2015.png'
export_name_multi = 'flow_multi_barplot_v02.png'
export_name_alf = 'alf_multi_barplot_v02.png'
...
stats = flow_stats(nat_flow[70105][:end])
yr_index = stats.loc[:, 'Tot data yrs'] >= 5
stats.loc[yr_index, 'Mean']
...
malf, alf, alf_mis = malf7d(nat_flow[70105][:end])
...
for i in range(len(river_names)):
    ...
    multi_yr_barplot(flow, nat_flow, col=river_sites, names_dict = site_names_dict, start=start, export_path=export_path, export_name=name + '_' + export_name_multi)

for i in range(len(river_names)):
    name = river_names[i]
    river_sites = river_lst[i]

    multi_yr_barplot(flow, nat_flow, alf=True, col=river_sites, names_dict = site_names_dict, start=start, export_path=export_path, export_name=name + '_' + export_name_alf)

dual_mon_boxplot(flow[[70105, 70103]], nat_flow[[70105, 70103]], col=[70105], export_path=export_path, export_name=export_name_flow)
dual_mon_boxplot(flow[start2:end], nat_flow[start2:end], export_path=export_path, export_name=export_name_flow_2004)
