...
base_dir = r'S:\Surface Water\shared\projects\waimak\data\2018-03-16'

flow_csv = 'recorded_est_flows.csv'
min_flow_trigs_csv = 'min_flow_trigs.csv'
flow_red_csv = 'flow_reductions.csv'
site_allo_csv = 'site_allo_current.csv'
...
export_flow_csv = 'mod_flow_base_current.csv'
export_big_flow_csv = 'mod_flow_combo_current.csv'
export_trigs_csv = 'trigs_current.csv'
export_mon_restr_csv = 'mon_restr_current.csv'
export_ann_restr_csv = 'ann_restr_current.csv'
...
extra1 = rd_sql_ts(server, database, table, 'Site', 'Time', 'Value', where_col={'FeatureMtypeSourceID': [5], 'Site': ['66204']}).Value
