...
## import parameters
series_csv = 'C:/ecan/shared/base_data/usage/usage_takes_mon_series_sw_up_with_cav.csv'
...
lw = w_query(allo_use2, grp_by=['dates', 'take_type', 'use_type'], use_col=['usage'], cwms_zone=cwms_zone, allo_col=allo_col, years=years, export_path=export_path)
