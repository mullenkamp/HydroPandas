...
export1 = 'crc_usage_summary_2018-10-02_v02.csv'
...
crc1 = crc.replace({'use_type': use_type_dict})

allo3 = pd.merge(allo2, crc1[['crc', 'take_type', 'allo_block', 'use_type']], on=['crc', 'take_type', 'allo_block'], how='left')
