...
## output parameters
export_fig_path = 'C:/ecan/local/Projects/requests/lower_waitaki/figures'
export_path = 'C:/ecan/local/Projects/requests/lower_waitaki/lower_waitaki_allo_use.csv'
...
lw = w_query(allo_use2, grp_by=['dates'], allo_col=allo_col, cwms_zone=cwms_zone, export_path=export_path)
