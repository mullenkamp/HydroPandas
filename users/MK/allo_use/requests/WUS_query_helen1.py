...
## output parameters
name = 'crc'
export_fig_path = 'C:/ecan/local/Projects/requests/helen/set1'
export_path = 'C:/ecan/local/Projects/requests/helen/set1/allo_use.csv'

allo_name = 'past_allo.png'
use_name = 'allo_use.png'
...
lw = w_query(allo_use2, grp_by=['dates', 'crc'], allo_col=allo_col, crc=crcs, export_path=export_path)
