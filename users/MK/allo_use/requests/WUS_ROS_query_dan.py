...
export_path = 'C:/ecan/Projects/otop/usage/otop_results_up5.csv'
...
q1 = w_query(allo_use1, grp_by=['dates', 'take_type', 'use_type'], allo_col=['ann_allo_m3', 'ann_allo_wqn_m3', 'up_allo_m3', 'up_allo_wqn_m3'], crc_rem=crc_rem, cwms_zone=cwms_zone, export_path=export_path)
