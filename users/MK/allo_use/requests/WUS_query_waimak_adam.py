...
waps_csv = 'C:/ecan/local/Projects/requests/adam/waimakariri_crc2.csv'
...
lw = w_query(allo_use2, grp_by=['dates', 'use_type'], wap=waps, allo_col=allo_col, years=years, export_path=export_path, debug=True)
