...
export_path = 'C:/ecan/Projects/otop/usage/otop_results_up3.csv'
...
q1 = w_query(allo_use1, grp_by=['dates', 'take_type'], allo_col=['ann_allo_m3', 'ann_allo_wqn_m3', 'up_allo_m3', 'up_allo_wqn_m3'], cwms_zone=cwms_zone, export_path=export_path)
