...
eval_fun = sm.tools.eval_measures
...
np.sqrt(np.mean((y - results.fittedvalues)**2))

eval_fun.rmse(y, results.fittedvalues)

eval_fun.stde(y, results.fittedvalues)
eval_fun.meanabs(y, results.fittedvalues)
eval_fun.bias(y, results.fittedvalues)
