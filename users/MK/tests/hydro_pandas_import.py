...
h1 = hydro().get_data(mtypes=mtypes1, sites=sites1, from_date=from_date, to_date=to_date, qual_codes=qual_codes)
...
export_csv1 = r'E:\ecan\git\Ecan.Science.Python.Base\users\MK\tests\test_long1.csv'
export_csv2 = r'E:\ecan\git\Ecan.Science.Python.Base\users\MK\tests\test_wide1.csv'
export_csv3 = r'E:\ecan\git\Ecan.Science.Python.Base\users\MK\tests\test_wide2.csv'
export_csv4 = r'E:\ecan\git\Ecan.Science.Python.Base\users\MK\tests\test_combine.csv'
#export_csv5 = r'E:\ecan\git\Ecan.Science.Python.Base\users\MK\tests\test_long1.csv'

export_shp = r'E:\ecan\git\Ecan.Science.Python.Base\users\MK\tests\sites_geo.shp'
export_nc = r'S:\Surface Water\temp\test_hydro1.nc'

### Export a time series csv

h3.to_csv(export_csv1)
h3.to_csv(export_csv2, pivot=True)
h3.to_csv(export_csv3, mtypes='flow', pivot=True)
gwl2.to_csv(export_csv4)

## Only recorders and pivot
h3.to_csv(export_csv1, mtypes='flow', pivot=True)

## Only gauging data in long format
h3.to_csv(export_csv2, mtypes='flow_m')
...
### csv files
new1 = hydro().rd_csv(export_csv2, dformat='wide', multiindex=True)
new1

new2 = hydro().rd_csv(export_csv1, time='time', mtypes='mtype', sites='site', values='data', dformat='long')
new2

new3 = hydro().rd_csv(export_csv3, time='time', mtypes='flow', dformat='wide')
new3
