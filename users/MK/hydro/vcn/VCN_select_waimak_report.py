...
site_loc_csv = 'C:/ecan/local/Projects/otop/GIS/tables/waimak_niwa_grid.csv'
site_col = 'Data VCN_s'
...
export_path = 'C:/ecan/local/Projects/requests/waimak_report/climate'
et_mon_png = 'waimak_et_mon.png'
et_yr_png = 'waimak_et_yr.png'
precip_mon_png = 'waimak_precip_mon.png'
precip_yr_png = 'waimak_precip_yr.png'
diff_mon_png = 'waimak_diff_mon.png'
diff_yr_png = 'waimak_diff_yr.png'
...
mon_boxplot(et_day, dtype='ET', fun='sum', export_path=export_path, export_name=et_mon_png)
