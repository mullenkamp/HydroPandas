...
try:
    ...
    del_mssql_table_rows(from_date=str(last_date1), to_date=today1, date_col='date', **sql_site_dict)
    del_mssql_table_rows(from_date=str(last_date1), to_date=today1, date_col='date', **sql_site_band_dict)
