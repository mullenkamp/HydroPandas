...
from core.ts.sw import malf7d, flow_stats, flow_reg
...
r_flow = flow_import(rec_sites=cwms_loc1)
...
set1 = concat([r_flow[64610], g_flow1[164307]], axis=1).dropna()

regplot(set1[64610], set1[164307])
