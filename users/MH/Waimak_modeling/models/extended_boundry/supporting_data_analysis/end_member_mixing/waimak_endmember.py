...
def mc_calc_end_members(outdir, sites, o18_u, o18_s, cl_u, cl_s, n=10000):
    ...
    for site in sites.keys():
        ...
        ax.set_title(site)
        ax.legend()
        fig.savefig(os.path.join(plot_dir, '{}.png'.format(site)))
...
if __name__ == '__main__':
    ...
    targets = pd.read_csv(r"P:\Groundwater\Matt_Hanson\waimaik_mixing_targets.csv", index_col=0)
    sites = {}
    ...
    mc_calc_end_members(r"C:\Users\MattH\Desktop\test_mixing", sites, end_mean_o18, end_sd_o18, end_mean_cl, end_sd_cl)
    print'done'
