...
if __name__ == '__main__':
    ...
    plot_targets = smt.df_to_array(targets2008[targets2008['include_non-gap']],'total_error_m',True)
    for layer in range(smt.layers):
        smt.plt_matrix(plot_targets[layer],no_flow_layer=layer,title='layer: {}'.format(layer))
