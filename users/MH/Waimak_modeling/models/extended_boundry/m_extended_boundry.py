...
if __name__ == '__main__':
    outdir = r"C:\Users\MattH\Desktop\data_to_brioch_28-08-2017"
    if not os.path.exists(outdir):
        os.makedirs(outdir)
    m = create_m_extended_boundry('with_full_LRZF_28-08-2017',r"{}\with_n_carpet".format(outdir),safe_mode=False,
