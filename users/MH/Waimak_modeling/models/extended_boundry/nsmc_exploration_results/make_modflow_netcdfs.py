...
def make_modflow_netcdfs(hds_nc_path, bud_nc_path):
    ...
    make_hds_netcdf(nsmc_nums=emma_nsmc_numbers, hds_paths=hds_paths, description=description, nc_path=hds_nc_path)
    make_cellbud_netcdf(nsmc_nums=emma_nsmc_numbers, sfo_paths=sfo_paths, cbc_paths=cbc_paths,
