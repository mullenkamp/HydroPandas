...
import time
from starting_hds_ss_sy import get_ss_sy, get_starting_heads_sd7
...
def well_by_well_depletion_sd7(model_id, well_list, base_path):
    """
    ...
    pool.join()
    with open("{}/forward_run_log/SD7_run_status.txt".format(smt.sdp), 'w') as f:
