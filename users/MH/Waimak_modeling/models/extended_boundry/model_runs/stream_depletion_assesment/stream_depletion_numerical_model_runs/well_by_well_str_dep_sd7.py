...
def well_by_well_depletion_sd7(model_id, well_list, base_path,notes):
    """
    ...
    with open("{}/forward_run_log/{}_SD7_run_status_{}_{:02d}_{:02d}_{:02d}_{:02d}.txt".format(smt.sdp,model_id,now.year,now.month,now.day,now.hour,now.minute), 'w') as f:
        f.write(str(notes) + '\n')
