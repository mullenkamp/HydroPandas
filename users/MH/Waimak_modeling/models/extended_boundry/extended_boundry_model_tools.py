...
from users.MH.Waimak_modeling.models.extended_boundry.m_packages.supporting_scripts import _elvdb_calc, _no_flow_calc

smt = ModelTools(
    'ex_bd_va', sdp='{}/ex_bd_va_sdp'.format(sdp), ulx=1512162.53275, uly=5215083.5772, layers=17, rows=364, cols=365,
    grid_space=200, no_flow_calc=_no_flow_calc, temp_file_dir=temp_file_dir, elv_calculator=_elvdb_calc, base_mod_path=None
)
