...
def _get_rch(): #todo if mike gets dave scott running before this model is done, spatialy vary the stuff to the south
    ...
    scaled_old_rch[part_zones==7] = old_rch[part_zones==7] * 190/1000/365/old_rch[part_zones==7].mean()
    scaled_old_rch[part_zones==8] = old_rch[part_zones==8] * 270/1000/365/old_rch[part_zones==8].mean()
